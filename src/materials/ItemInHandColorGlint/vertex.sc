...
void main() {
  ...
  vec4 position = jitterVertexPosition(wpos);
    ...
    fogColor.a = nlRenderFogFade(env, skycol, fogColor.rgb, relativeDist, FogColor.rgb, FogControl.xy, wpos.xyz, vec3(0.0,0.0,0.0), ViewPositionAndTime.w);
