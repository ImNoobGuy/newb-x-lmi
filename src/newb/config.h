...
#define NL_DAWN_HORIZON_COL  vec3(2.5, 0.7, 0.1)
#define NL_DAWN_EDGE_COL     vec3(1.65, 1.4, 0.2)
...
#define NL_NIGHT_HORIZON_COL vec3(0.01,0.05,0.27)*0.5 + 0.1
#define NL_NIGHT_EDGE_COL    vec3(0.01,0.05,0.27)*0.5 + 0.1
...
#define NL_RAINBOW_CLEAR 0.8 // 0.3 subtle ~ 1.7 bright during clear
