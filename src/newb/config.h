...
#define NL_MIST_DENSITY 1.5      // 0.0 no mist ~ 1.0 misty
...
/* Underwater */
#define NL_UNDERWATER_BRIGHTNESS 0.75         // 0.0 dark ~ 3.0 bright
...
/* Multilayer Rounded cloud settings */
...
/* Galaxy */
//#define NL_GALAXY_STARS 3.0           // [toggle] 0.1 dim - 4.0 bright
...
#define NL_GLINT_INTENSITY 26.0
