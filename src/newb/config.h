...
#define NL_EXPOSURE 1.26              // [toggle] 0.5 dark ~ 3.0 bright
#define NL_SATURATION 1.24            // [toggle] 0.0 grayscale ~ 4.0 super saturated
...
#define NL_MORNING_SUN_COL vec3(1.0,0.45,0.0)*1.5 + 0.9
...
#define NL_UNDERWATER_TORCH_COL vec3(1.0,0.62,0.18)
...
#define NL_DAY_ZENITH_COL    vec3(0.34,0.54,1.0)
...
/* Waving */
#define NL_WAVE_RANGE 13.0     // 5.0 close ~ 64.0 far
...
/* Water */
#define NL_WATER_TRANSPARENCY 0.58 // 0.0 transparent ~ 1.0 normal
...
/* Underwater */
#define NL_UNDERWATER_BRIGHTNESS 0.45         // 0.0 dark ~ 3.0 bright
...
#define NL_CLOUD2_SHAPE vec2(0.57, 0.57)     // 0.0 round ~ 1.0 box vec2(horizontal shape, vertical shape)
