...
#define NL_GAMMA 1.43                  // 0.3 low ~ 2.0 high
...
#define NL_NIGHT_BRIGHTNESS -0.38 // 0.0 dark ~ 2.0 bright
...
#define NL_MORNING_SUN_COL vec3(1.0,0.45,0.0)*1.5
...
#define NL_NETHER_AMBIENT vec3(1.0,0.349,0.0)
#define NL_END_AMBIENT    vec3(1.98,1.25,2.3)

/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.0, 0.5, 0.29)
#define NL_UNDERWATER_TORCH_COL vec3(1.0,0.62,0.38)
#define NL_NETHER_TORCH_COL     vec3(1.0,0.52,0.18)
#define NL_END_TORCH_COL        vec3(0.84,0.62,1.0)

/* Fog */
#define NL_FOG 1.0                // [toggle] 0.1 subtle ~ 1.0 blend with sky completely
#define NL_MIST_DENSITY 1.8      // 0.0 no mist ~ 1.0 misty
...
#define NL_DAWN_ZENITH_COL   vec3(0.05,0.2,0.4)
#define NL_DAWN_HORIZON_COL  vec3(1.5,0.2,0.2)
#define NL_DAWN_EDGE_COL     vec3(1.5,0.2,0.2)

#define NL_DAY_ZENITH_COL    vec3(0.14,0.34,1.0)
#define NL_DAY_HORIZON_COL   vec3(0.68,0.88,1.0)
#define NL_DAY_EDGE_COL      vec3(0.68,0.88,1.0)

#define NL_NIGHT_ZENITH_COL  vec3(0.058,0.07,0.09)*0.2
#define NL_NIGHT_HORIZON_COL vec3(0.01,0.05,0.27)*0.7 + 0.1
#define NL_NIGHT_EDGE_COL    vec3(0.01,0.05,0.27)*0.7 + 0.1

#define NL_RAIN_ZENITH_COL   vec3(0.25,0.25,0.25)
#define NL_RAIN_HORIZON_COL  vec3(0.45,0.45,0.45)*0.6

#define NL_END_ZENITH_COL    vec3(0.0,0.0,0.0)
#define NL_END_HORIZON_COL   vec3(0.3,0.0,0.6)
...
#define NL_UNDERWATER_STREAKS 1.22            // [toggle] 0.8 subtle - 2.0 bright streaks from top
...
#define NL_CLOUD0_OPACITY 1.5        // 0.0 invisible ~ 1.0 opaque
...
#define NL_CLOUD2_LAYER2_RAIN_THICKNESS 3.1     // 0.7 slim ~ 5.0 fat
#define NL_CLOUD2_LAYER2_SCALE vec2(0.028, 0.028) // 0.003 large ~ 0.3 tiny
...
#define NL_CLOUD2_LAYER2_VELOCITY 0.75           // 0.0 static ~ 4.0 very fast
...
#define NL_SHOOTING_STAR_DELAY 3.0 // 0.0 no delay ~ 100.0 long time (100 secs)
...
#define NL_GODRAY // [toggle] 0.1 subtle ~ 0.8 strong
...
#define NL_LAVA_NOISE_BUMP 0.9 // [toggle] 0.1 subtle ~ 0.8 massive waves
#define NL_LAVA_NOISE_SPEED 0.03 // 0.0 still ~ 0.1 fast
